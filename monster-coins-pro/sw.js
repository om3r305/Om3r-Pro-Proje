const CACHE='monster-coins-pro-shell-v11';
const ASSETS=[
  '/','/dashboard.css','/dashboard.js','/dip-cloud-status-v7.js','/manifest.webmanifest','/brand.svg','/logo.svg',
  ...
  '/dip-expert-v4-ui.js','/dip-expert-v4-hotfix.js','/dip-expert-v4-runtime-guard.js','/dip-expert-v5-brain.js','/dip-server-authoritative-v7.js'
];
