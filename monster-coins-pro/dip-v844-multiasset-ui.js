  ...
  function ensure(){
    ...
    panel.innerHTML=`
      ...
      <div class="md-box md-arena">
        ...
        <div class="md-note">Dinamik seçim: patlama eşiği piyasanın o anki üst dilimine göre ayarlanır; normal aday iki tarama üst üste doğrulanmadan para almaz. Yük koruması: ikinci piyasa taraması yok; ana 32 derin tarama paylaşılır, ayrı evaluation geçmişi yazılmaz.</div>
      </div>
