  ...
  function ensure(){
    ...
    panel.innerHTML=`
      ...
      <div class="md-box md-arena">
        <div class="md-arena-head"><div><div class="md-arena-title">🧨 AGGRESSIVE ARENA · $1000 paralel SHADOW kasa</div><div class="md-meta">Aynı Brian gözleri ve aynı tarama. EXPLOSION-FIRST: düşük patlama skorlu sinyale para bağlamaz; güçlü fırsatta top-2 yoğunlaşır, MONSTER/ULTRA gelirse %85–99.5 kasa test edilebilir.</div></div><div id="mdArenaBadge" class="md-arena-badge">BAĞLANIYOR</div></div>
        ...
        <div class="md-note">EXPLOSION-FIRST taban filtresi: Patlama ≥78, Brain ≥78, Opportunity ≥72, Continuation ≥72 ve pozitif forecast. Yük koruması: ikinci piyasa taraması yok; ana 32 derin tarama paylaşılır, ayrı evaluation geçmişi yazılmaz.</div>
      </div>
