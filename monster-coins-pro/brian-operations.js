...
(function(){
 ...
 const roomActions={meeting:()=>$('openMeeting')?.click(),accounting:()=>window.openTreasuryAccounting?.(),positions:()=>typeof window.openTreasuryAccountingPositions==='function'?window.openTreasuryAccountingPositions():window.openTreasuryAccounting?.(),anatomy:()=>window.openBrianAnatomy?.(),engineering:()=>window.openBrianEngineeringRoom?.()};
