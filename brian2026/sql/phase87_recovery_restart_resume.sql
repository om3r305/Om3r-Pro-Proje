-- Brian Phase 87 DRAFT SQL: durable recovery backlog / restart resume view.
--
...
--
-- Phase86 prevents new normal admission while recovery is unresolved. Phase87
-- gives a restarted worker a deterministic DB-authoritative "what recovery work
-- is next?" view so it can resume without waiting for the original governed
-- signal to arrive again.
