...
const MAIN_CAPABILITIES: CapabilityDefinition[] = [
  {
    ...
    collectorIds: ["brian-realtime-universe-heartbeat", "brian-universe-collector"],
  ...
  },
  {
    ...
    collectorIds: ["brian-realtime-sensor-heartbeat", "brian-sensor-mesh"],
    staleAfterSeconds: 600,
  ...
  },
  {
    ...
    collectorIds: ["brian-realtime-intrabar-heartbeat", "brian-intrabar-eye"],
  ...
  },
  {
    ...
    description: "Observes funding, open interest and derivatives taker context across the split Realtime/Core architecture.",
    collectorIds: ["brian-realtime-derivatives-heartbeat", "phase39-binance-usdm-derivatives", "brian-derivatives-eye"],
  ...
  },
  {
    ...
    domain: "MARKET_DATA",
    name: "On-Demand L2 Cost Capture",
    description: "Captures real order-book state on demand for candidate entries so spread, depth and round-trip cost can be measured before an ALPHA action.",
    collectorIds: ["brian-l2-on-demand"],
    staleAfterSeconds: 600,
    dependencies: ["market.universe"],
    limitations: ["on-demand snapshots are real L2 evidence but do not continuously model queue movement, adverse selection or full order-book dynamics"],
    expectedStage: "ACTIVE",
  },
  {
  ...
  },
  {
    ...
    collectorIds: ["brian-realtime-fx-heartbeat", "phase39-ecb-fx", "brian-fx-eye"],
  ...
  },
  {
    ...
    description: "Actively exits invalidated, stale, flipped or risk-stopped positions and recycles capital into stronger opportunities through Treasury.",
    collectorIds: ["brian-evolution-treasury-v1"],
    staleAfterSeconds: 600,
    dependencies: ["portfolio.treasury"],
    limitations: ["shadow only", "replacement requires a measured advantage after incremental exit cost"],
    expectedStage: "ACTIVE",
  },
];
...
const FUTURE_REQUIRED: Array<Omit<CapabilityDefinition, "collectorIds" | "staleAfterSeconds">> = [
  {
    capabilityId: "market.l2-continuous",
    domain: "MARKET_DATA",
    name: "Continuous L2 Microstructure",
    description: "Continuously tracks order-book changes, queue dynamics and adverse-selection risk beyond the existing on-demand L2 snapshots.",
    dependencies: ["market.l2"],
    limitations: ["research target; must justify its compute cost with measurable after-cost ALPHA improvement"],
