import { buildCodeCandidatePlan, buildExperimentPlan, detectDrift, evaluatePromotion, generateResearchHypotheses, type ResearchInputs } from "./evolution_research.ts";
