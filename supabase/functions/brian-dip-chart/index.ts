...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    return out({status:'OK',source:'BINANCE_USDM_PERP',symbol:'ETHUSDT',interval:'1m',generated_at:new Date().toISOString(),last_price:candles.at(-1)?.c??null,candles},200,o);
