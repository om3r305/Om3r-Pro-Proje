-- During backlog recovery, keep current ALPHA observability fresh first.
-- New due decisions consume only a fraction of the bounded 120-row batch; spare capacity
-- continues draining older backlog on subsequent runs. SHADOW ONLY.
